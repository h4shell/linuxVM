...
echo  ---------------------------------
echo.
"C:\Program Files\qemu\qemu-system-x86_64.exe" -hda alpine.img -boot c -m 1024 -netdev user,id=n1,hostfwd=tcp::20000-:22,hostfwd=tcp::2222-:2222 -device virtio-net,netdev=n1 -machine q35 -nographic -smp 6 -serial none -monitor none
